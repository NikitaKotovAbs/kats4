...
namespace Praktan5
{
    ...
    {
        static string[] forma = new string[5] { "  Круг - 100;", "  Квадрат- 200;", "  Треуголькик - 300;", "  Ромб - 400;", "  Звезда- 500;" };
        static string[] size = new string[5] { "  Малый - 300;", "  Средний - 450;", "  Большой- 600;", "  Подарочный - 900;", "  Свадебный - 1200;" };
        static string[] vkus = new string[5] { "  Клубничный - 300;", "  Малиновый - 400;", "  Шоколадный - 200;", "  Ореховый - 600;", "  Сметанный - 100;" };
                            ...
                            case ConsoleKey.Enter:
                                switch (position)
                                {
                                    ...
                                    case 9:
                                        ...
                                        File.AppendAllText("C:\\Users\\Никита\\source\\repos\\Praktan5\\Заказы тортов.txt", $"Время заказа {date}\r\n Цена: {x}\r\n Состав заказа: {y}\r\n");
                                        x = 0;
                                        y = "";
                                        SubClass.x = 0;
                                        SubClass.y = "";
